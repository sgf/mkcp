...
namespace mkcp {
    ...
    //压缩方案：
    //conv:可以缩小到2位，最大支持6万个链接。（涉及到：UDP NAT 设备 端口变动）
    //Wnd:可以缩小到4位， 规定窗口大小必须为 64的整数倍,范围1-63。 最小 64*1=64，最大 64*63=4032
    //len:可以缩小到10位长度， 规定窗口大小必须为 2的整数倍,范围1-1020。 最小 2*1=2，最大 2*1020=2040
